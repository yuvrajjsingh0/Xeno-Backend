...
// app.post('/api/customers/rules', async (req: Request, res: Response) => {
...
// app.get('/api/audiences/:id', async (req: Request, res: Response) => {
//   res.status(200).send(await audienceService.getById(Number(req.params.id)));
// });

// app.post('/api/audiences/:id/startCampaign', async (req: Request, res: Response) => {
...
// app.get('/api/audiences/:id/campaignLog', async (req: Request, res: Response) => {
